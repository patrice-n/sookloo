...
#### Quelques caractéristiques de ces types de modèles de mémoire
...
#### L'allocation dynamique et l'allocation statique
...
#### Comparaison de la mémoire de pile (stack) et la mémoire de tas (heap)
